...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface-0">
      {/* Background glow */}
      <div className="fixed top-[-200px] right-[-100px] w-[600px] h-[600px] bg-brand-600 rounded-full filter blur-[150px] opacity-[0.06] pointer-events-none" />
      ...
      <div className="w-full max-w-sm mx-auto px-4 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl text-zinc-100">Welcome back</h1>
          <p className="text-sm text-zinc-500 mt-1">
            Sign in to your SEO Tracker account
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2.5 bg-surface-100 border border-zinc-800 rounded-lg text-sm text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:ring-1 focus:ring-brand-500 focus:border-brand-500"
